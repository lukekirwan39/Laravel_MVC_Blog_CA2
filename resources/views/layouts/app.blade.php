...
<body class="bg-gray-100 h-screen antialiased leading-none font-sans" x-data="{ darkMode: localStorage.getItem('darkMode') === 'true' }" :class="{ 'bg-gray-900 text-white': darkMode }">
<div id="app">
        ...
        <div class="container mx-auto flex justify-between items-center px-6">
            ...
            <nav class="space-x-4 text-gray-300 text-sm sm:text-base flex items-center">
                ...
                @else
                    ...
                    <!-- Dark Mode Toggle -->
                    <button @click="darkMode = !darkMode; localStorage.setItem('darkMode', darkMode)" class="ml-4 bg-gray-700 px-3 py-1 rounded text-white hover:bg-gray-600">
