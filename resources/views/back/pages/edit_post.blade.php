...
@section('content')
    <div class="mb-5 flex items-center justify-between">
        <h2 class="text-lg font-semibold dark:text-white-light">Edit post</h2>
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="mb-3">
                            ...
                            <input type="text" placeholder="Some Text..." class="form-input" name="post_title" value="{{ $post->post_title }}">
                            <span class="text-danger error-text post_title_error"></span>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="ctnTextarea">Post Content</label>
                            <textarea name="post_content" id="ctnTextarea" rows="3" class="form-textarea" placeholder="Content..." >{!! $post->post_content !!}</textarea>
                ...
                if (file) {
                    if (!allowedTypes.includes(file.type)) {
                        Swal.fire({
                            ...
                            text: 'Only JPG, JPEG, and PNG files are allowed for image updates.',
