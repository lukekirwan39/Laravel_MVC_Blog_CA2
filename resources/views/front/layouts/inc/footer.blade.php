<footer class="bg-dark mt-5">
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto text-center">
                <a class="d-inline-block mb-4 pb-2" href="/">
                    <img loading="prelaod" decoding="async" class="img-fluid" src="{{ asset(blogInfo()->blog_logo) }}"
    ...
    <div class="copyright bg-dark content">&copy; <script>document.write(new Date().getFullYear())</script>
