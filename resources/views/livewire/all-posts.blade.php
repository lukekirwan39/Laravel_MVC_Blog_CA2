            ...
            <div class="w-full max-w-sm">
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Post title</h5>
                    </div>
                    <div class="mb-5">
                        <form class="space-y-5">
                            <div class="px-4 py-2 flex items-center justify-between">
                                    <button class="text-primary" x-tooltip="Edit" wire:click.prevent="editCategory(2)">
                                    ...
                                    <button type="button" x-tooltip="Delete" class="text-danger">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 m-auto">
