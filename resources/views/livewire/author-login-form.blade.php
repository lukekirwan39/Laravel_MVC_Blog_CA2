            ...
            <form class="space-y-5 dark:text-white" @submit.prevent="window.location='index.html'">
                <div>
                    ...
                    <div class="relative text-white-dark">
                        <input id="Email" type="text" placeholder="Enter Email or Username" class="form-input ps-10 placeholder:text-white-dark" wire:model="login_id">
                ...
                <div>
                    ...
                    <div class="relative text-white-dark">
                        <input id="Password" type="password" placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark" wire:model="password">
                        <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <div class="text-center dark:text-white">
                    ...
                    <a href="{{ route('author.register') }}" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">SIGN UP</a>
                </div>
            </form>
        </div>
    </form>
