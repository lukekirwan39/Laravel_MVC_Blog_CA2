    ...
    <div class="mx-auto w-full max-w-[440px]">
        <div class="mb-10">
            @if(Session::get('success'))
                <div class="alert alert-success" style="background: #ffffff; border-left: 5px solid #28a745; margin-bottom: 5px;">
                    {{Session::get('success')}}
                </div>
            @endif
        ...
        <form class="space-y-5 dark:text-white" method="post" wire:submit.prevent="ForgotHandler()">
            <div>
                <label for="Email">Email</label>
                <div class="relative text-white-dark">
                    <input id="Email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark" wire:model="email">
