<div>
    <form class="space-y-5 dark:text-white" wire:submit.prevent="RegisterHandler">
            ...
            <div class="mx-auto w-full max-w-[440px]">
                ...
                @if(Session::has('success'))
                    <div class="alert p-3 rounded shadow-sm"
                         style="background: #ffffff; border-left: 5px solid #28a745; margin-bottom: 5px;">
                ...
                <form class="space-y-5 dark:text-white" @submit.prevent="window.location='index.html'">
                    <div>
                        ...
                        <div class="relative text-white-dark">
                            <input wire:model="name" id="Name" type="text" placeholder="Enter Name" class="form-input ps-10 placeholder:text-white-dark">
                    ...
                    <div>
                        ...
                        <div class="relative text-white-dark">
                            <input wire:model="register_id" id="Email" type="email" placeholder="Enter Email" class="form-input ps-10 placeholder:text-white-dark">
                            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <div>
                        ...
                        <div class="relative text-white-dark">
                            <input wire:model="register_password" id="Password" type="password" placeholder="Enter Password" class="form-input ps-10 placeholder:text-white-dark">
                            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                ...
                <div class="text-center dark:text-white">
                    ...
                    <a href="{{route ('author.login') }}" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">SIGN IN</a>
                </div>
            </div>
        </div>
    </form>
